        ...
        },
        {
          ...
          handler: async (request, h) => {
            ...
            try {
              ...
              const modelConfig = model === 'model1' ?
                { model: 'gpt-4o', apiVersion: '2025-01-01-preview' }
                : { model: 'gpt-4', apiVersion: '2024-12-01-preview' }
              ...
              try {
                ...
                const openai = new OpenAI({
                  apiKey: apiKey,
                  baseURL: `${apiUrl}openai/deployments/${modelConfig.model}`,
                ...
                const completion = await openai.chat.completions.create({
                  messages: [
                    {
                      role: 'system',
                      content: `Evaluate the text based on the Green Book CENTRAL GOVERNMENT GUIDANCE ON APPRAISAL AND EVALUATION given below and
                ...
                logger.info(`OpenAI API response: ${summary}`)
